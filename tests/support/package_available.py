...
from lightning.fabric import accelerators as fabric_accelerators
...
_tpu_accelerator: Any = getattr(fabric_accelerators, "TPUAccelerator", None)
_TPU_AVAILABLE = bool(_tpu_accelerator and _tpu_accelerator.is_available())
